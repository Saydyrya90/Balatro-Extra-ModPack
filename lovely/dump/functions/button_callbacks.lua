LOVELY_INTEGRITY = 'd5993722be3826788a81f82375040c76a735a273a2bc4502bf77ca971b1919b0'
...
G.FUNCS.hand_text_UI_set = function(e)
  ...
  G.FUNCS.can_discard = function(e)
    if G.GAME.current_round.discards_left <= 0 or #G.hand.highlighted <= 0 or (G.GAME.THE_8_BYPASS and (#G.hand.highlighted > G.hand.config.highlighted_limit)) then
        e.config.colour = G.C.UI.BACKGROUND_INACTIVE
        e.config.button = nil
    else
        e.config.colour = G.C.RED

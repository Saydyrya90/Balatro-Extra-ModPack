LOVELY_INTEGRITY = '5effe038424bfed95b350a4bc9b215092405942ef485a10ec49ce509b9639a86'
...
function create_card(_type, area, legendary, _rarity, skip_materialize, soulable, forced_key, key_append)
    ...
    if _type == 'Joker' then
        ...
        if card.config.center.key == 'j_bunc_jmjb' then edition = poll_edition(nil, nil, true, true) end

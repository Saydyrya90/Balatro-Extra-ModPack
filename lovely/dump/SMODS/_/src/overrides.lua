LOVELY_INTEGRITY = '512f5f488b7db9508bd70adf583752d0772b0f3238a3989a188a6c974eb3df0c'
...
function poll_edition(_key, _mod, _no_neg, _guaranteed, _options)
	...
	if not _options then
		...
		if _key == "wheel_of_fortune" or _key == "aura" then -- set base game edition polling
		   if BUNCOMOD.content.config.gameplay_reworks then table.insert(_options, 'e_bunc_glitter') end
		else
